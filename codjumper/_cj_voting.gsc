...
compareAndAction(vote, against, arg)
{
	switch(vote)
	{
		...
		case "Vote: Rotate Map":
			thread maps\mp\gametypes\_gamelogic::endGame(undefined, "Vote Passed - Rotating Map");
			break;
		case "Vote: Change Map":
			rotation = " map " + arg + " " + getDvar("sv_mapRotationCurrent");
			setDvar( "sv_mapRotationCurrent", rotation);
			wait 3;
			thread maps\mp\gametypes\_gamelogic::endGame(undefined, "Vote Passed - Changing Map");
			break;
		default:
