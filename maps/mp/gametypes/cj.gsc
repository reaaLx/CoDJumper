...
main()
{
	...
	maps\mp\_utility::registerScoreLimitDvar( level.gameType, 1000, 0, 5000 );
...
onStartGameType()
{
	...
	setObjectiveText( "allies", &"CJ_NULL" );
	setObjectiveText( "axis", &"CJ_NULL" );

	setObjectiveScoreText( "allies", &"CJ_NULL" );
	setObjectiveScoreText( "axis", &"CJ_NULL" );

	setObjectiveHintText( "allies", &"CJ_NULL" );
	setObjectiveHintText( "axis", &"CJ_NULL" );
